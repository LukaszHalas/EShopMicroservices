...
public class CatalogInitialData : IInitialData
{
    public async Task Populate(IDocumentStore store, CancellationToken cancellation)
    {
        ...
        // UPSERT, czyli skrót od "update or insert", to operacja bazy danych, która wstawia nowy wiersz,
        // jeśli nie istnieje, lub aktualizuje istniejący wiersz, jeśli istnieje 
